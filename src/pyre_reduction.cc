...
Reduct::Reduct(double reduct_current, double reduct_li2o, double reduct_volume, double reduct_time) {
  current = reduct_current;
  lithium_oxide = reduct_li2o;
...
Material::Ptr Reduct::ReductSepMaterial(std::map<int, double> effs, Material::Ptr mat) {
