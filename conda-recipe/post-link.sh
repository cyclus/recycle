# This script replaces the recycle_unit_tests commands with a simple
...
mv $PREFIX/bin/recycle_unit_tests $PREFIX/bin/recycle_unit_tests_base
echo "#!/bin/bash
...
$PREFIX/bin/recycle_unit_tests_base \$*
" > $PREFIX/bin/recycle_unit_tests
chmod 755 $PREFIX/bin/recycle_unit_tests
